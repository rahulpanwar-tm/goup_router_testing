...
-- Dumping structure for table goup_router_development.sim_map
DROP TABLE IF EXISTS `sim_map`;
CREATE TABLE `sim_map` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='This table is used to create unique identifier .';
