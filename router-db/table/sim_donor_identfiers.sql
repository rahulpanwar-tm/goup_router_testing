...
-- Dumping structure for table goup_router_development.sim_donor_identfiers
...
CREATE TABLE IF NOT EXISTS `sim_donor_identfiers` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='This is OEM ''s unique mapping of unique sime identifier with  sim id ';
