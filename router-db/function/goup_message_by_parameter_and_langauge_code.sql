...
-- Dumping structure for function development_goup_router.goup_message_by_parameter_and_langauge_code
DROP FUNCTION IF EXISTS `goup_message_by_parameter_and_langauge_code`;
DELIMITER //
CREATE DEFINER=`developer`@`%` FUNCTION `goup_message_by_parameter_and_langauge_code`(
