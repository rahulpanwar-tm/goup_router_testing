...
-- Dumping structure for table goup_router_development_ui.bulk_upload_sim_inventory_errors
...
CREATE TABLE IF NOT EXISTS `bulk_upload_sim_inventory_errors` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This table stores details of temporary sim inventory errors before inserting data into actual tables.';
